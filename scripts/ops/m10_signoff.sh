...
require_file "scripts/ops/deploy_preflight.sh"
...
require_pattern "docs/CROSS_PLATFORM.md" "Portability Signoff Checklist"
require_pattern "docs/CROSS_PLATFORM.md" "DEPLOY_PREFLIGHT_VALIDATE_COMPOSE=1"
require_pattern "Makefile" "^m10-signoff:"
require_pattern "Makefile" "^deploy-preflight:"
require_pattern "scripts/ops/deploy_preflight.sh" "DEPLOY_PREFLIGHT_VALIDATE_COMPOSE"
