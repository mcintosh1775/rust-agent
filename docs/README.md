...
- `message.send` persists outbound connector envelopes locally and can publish White Noise events to configured Nostr relays using either local-key or NIP-46 remote signing
- `message.receive` persists inbound connector envelopes locally for operator-facing replay/agenting flows
